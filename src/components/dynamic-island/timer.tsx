...
export default function Timer({ handleViewClick }: TimerProps) {
  ...
  return (
    <div className="flex w-[284px] items-center gap-2 py-3 pl-3.5 pr-5">
      <motion.button
        aria-label="Puase timer"
        whileTap={{ scale: 0.9 }}
        onClick={handlePuasedClick}
        className="flex h-10 w-10 items-center justify-center rounded-full bg-[#5A3C07] transition-colors hover:bg-[#695608]"
      >
